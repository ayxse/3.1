<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ViewAllDoc.aspx.vb" Inherits="Employee_ViewDoc" %>
...
<div id="wrapper">
	...
	<div id="page">
        <asp:GridView ID="grid1" runat ="server" CssClass ="gdstyle " 
            ...
            CellPadding="100" DataSourceID="SqlDataSource1" CellSpacing = "100"
            GridLines="Horizontal" PageSize="8" Font-Names="Times New Roman">
            <Columns>
                <asp:CommandField ShowSelectButton="True" />
                <asp:BoundField DataField="DocId" HeaderText="Examiner ID" 
                    SortExpression="DocId" />
                <asp:BoundField DataField="DocType" HeaderText="Course Name" 
                    SortExpression="DocType" />
                <asp:BoundField DataField="DocDate" HeaderText="Date" 
                    SortExpression="DocDate" />
                <asp:BoundField DataField="Empname" HeaderText="Professor ID" 
                    SortExpression="Empname" />
                <asp:BoundField DataField="DocContent" HeaderText="Comments" 
                    SortExpression="DocContent" />
                <asp:BoundField DataField="pname" HeaderText="Qname" SortExpression="pname" />
                <asp:BoundField DataField="purl" HeaderText="Qurl" SortExpression="purl" />
            </Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT * FROM [DocFileTab]">
        </asp:SqlDataSource>
    <br class="clearfix" />
	</div>
	<div id="page-bottom">
