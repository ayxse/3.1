...
<div id="wrapper">
	...
	<div id="menu">
		<ul>
            ...
            <li>
				...
				<ul>
                    <li><a href="NewDoc.aspx" >New Paper</a></li>
					<li><a href="ViewAllDoc.aspx" >View Question Papers</a></li>
	...
	<div id="page" class="style3">
        <asp:Label ID="DocumentID" runat="server" Text="Document ID" CssClass ="lblS1 " 
        ...
        <asp:Label ID="Label1" runat="server" Text="Document Type" CssClass ="lblS2 " 
            style="left: 47px; top: 81px"></asp:Label>
        <asp:Textbox ID="DocType" runat="server" Text="" CssClass ="style5"></asp:Textbox>
        <asp:Label ID="Label2" runat="server" Text="Content" CssClass="lblS3 " 
