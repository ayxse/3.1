<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Categorylists.aspx.vb" Inherits="Admin_Categorylists" %>
        ...
        <asp:GridView ID="grid1" runat ="server" CssClass ="gdstyle " 
            ...
            <Columns>
                <asp:BoundField DataField="Name" HeaderText="Course Name" 
                    SortExpression="Name" />
                <asp:BoundField DataField="Dscp" HeaderText="Description" 
                    SortExpression="Dscp" />
            </Columns>
