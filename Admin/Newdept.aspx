<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Newdept.aspx.vb" Inherits="Admin_Default" %>
...
<body>
    ...
    <p>
        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
            ControlToValidate="DpName" CssClass="style4" 
            ErrorMessage="Enter Alphabets Only" ValidationExpression="[ a-z A-Z ]+" 
            
            
            style="z-index: 1; position: absolute; top: 830px; left: 974px; height: 30px; width: 200px"></asp:RegularExpressionValidator>
...
<div id="wrapper">
    ...
    <div>
        <br />
        <br />
        <asp:Label ID="pass" runat="server" Text ="Department  Name" CssClass ="lblstyle1" > </asp:Label>
        <asp:Label ID="cpass" runat="server" Text ="Address" CssClass ="lblstyle2" > </asp:Label>
        <asp:TextBox ID="DpName" runat ="server" CssClass ="txtstyle1"></asp:TextBox>
        <asp:TextBox ID="Daddr" runat ="server" CssClass ="txtstyle2" 
