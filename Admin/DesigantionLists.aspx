<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DesigantionLists.aspx.vb" Inherits="Admin_DesigantionLists" %>
...
<body>
	...
	<div id="slider">
        ...
        <asp:GridView ID="grid1" runat ="server" CssClass ="gdstyle " 
            ...
            <Columns>
                <asp:BoundField DataField="Name" HeaderText="Designation Name" 
                    SortExpression="Name" />
                <asp:BoundField DataField="Dscp" HeaderText="Dscp" SortExpression="Dscp" />
            </Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT * FROM [Desg]">
        </asp:SqlDataSource>
    <br /><br /><br />
	</div>
	<div id="page-bottom">
