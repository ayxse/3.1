<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AllDocumentsList.aspx.vb" Inherits="Admin_AllDocumentsList" %>
...
<div id="wrapper">
	...
	<div id="page">
            ...
            <Columns>
                <asp:BoundField DataField="DocId" HeaderText="Course Id" 
                    SortExpression="DocId" />
                <asp:BoundField DataField="DocType" HeaderText="Course Name" 
                    SortExpression="DocType" />
                <asp:BoundField DataField="DocDate" HeaderText="Date of Paper" 
                    SortExpression="DocDate" />
                <asp:BoundField DataField="Empname" HeaderText="Examiner Name" 
                    SortExpression="Empname" />
                <asp:BoundField DataField="DocContent" HeaderText="Course Details" 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ConnectionString="<%$ ConnectionStrings:IntekConnectionString %>" 
                ...
                SelectCommand="SELECT [DocId], [DocType], [DocDate], [Empname], [DocContent] FROM [DocFileTab]">
        </asp:SqlDataSource>
