<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AllEmployeeList.aspx.vb" Inherits="Admin_AllEmployeeList" %>
		...
		<ul>
            ...
            <li>
				...
				<ul>
                    ...
                    <li><a href="AllDocumentsList.aspx" >All Courses lists </a></li>
	...
	<div id="slider">
        ...
        <asp:GridView ID="grid1" runat ="server" CssClass ="gdstyle " 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="EmpID" HeaderText="Examiner ID" ReadOnly="True" 
                    SortExpression="EmpID" />
                <asp:BoundField DataField="Name" HeaderText="Name of Examiner" 
                    SortExpression="Name" />
                ...
                <asp:BoundField DataField="Dept" HeaderText="Department" 
                    SortExpression="Dept" />
                <asp:BoundField DataField="DOR" HeaderText="Date of Registration" 
                    SortExpression="DOR" />
            </Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT [EmpID], [Name], [Address], [Desg], [Dept], [DOR] FROM [Employee]">
        </asp:SqlDataSource>
    <br /><br /><br />
	</div>
	<div id="page-bottom">
