<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DepartmentLists.aspx.vb" Inherits="Admin_DepartmentLists" %>
...
<body>
	...
	<div id="slider">
        ...
        <asp:GridView ID="grid1" runat ="server" CssClass ="gdstyle " 
            ...
            <Columns>
                <asp:BoundField DataField="Name" HeaderText="Name of Department" 
                    SortExpression="Name" />
