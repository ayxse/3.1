<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Sregister.aspx.vb" Inherits="Admin_Sempregister" %>
...
<div id="wrapper">
    ...
    <div>
    <p class="ss "> Successfully registered <a href="AdminHome.aspx"> Click here go to the home page </a>   </p>
    <br /><br /><br /><br />
    </div>
    <div id="page-bottom">
		<br class="clearfix" />
