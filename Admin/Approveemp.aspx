<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Approveemp.aspx.vb" Inherits="Admin_ApproveCnt" %>
...
<body>
	...
	<div id="slider">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT [EmpID], [Name], [Address], [Desg], [Dept], [DOR] FROM [Employee] where [Approve]='Pending'">
        </asp:SqlDataSource>
    <br /><br /><br />
	</div>
	<div id="page-bottom">
