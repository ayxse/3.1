<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ClientApprove.aspx.vb" Inherits="Admin_ClientApprove" %>
	...
	<div id="slider">
        ...
        <asp:GridView ID="grid1" runat ="server" CssClass ="gdstyle " 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Name" HeaderText="Professor Name" 
                    SortExpression="Name" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT [CntID], [Name], [Address], [PhoneNo], [Email] FROM [Client] where [approve]='pending'">
        </asp:SqlDataSource>
    <br /><br /><br />
	</div>
	<div id="page-bottom">
